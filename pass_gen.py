...
class PasswordGenerator:
    ...
    @staticmethod
    def gen_password(sequence, passlength=2):
...
class Interface:
    ...
    def generate_password(self, lenght):
        ...
        print("Your Password: ", PasswordGenerator.gen_password(sequence, lenght))
...
class Run:
    def decide_operation(self):
        user_input = input("Please enter you password length: ")
        try:
            int(user_input)
...
{list_to_vertical_string(Interface.has_characters.keys())}
        ...
        while True:
            ...
            count -= 1
            if count == 0:
                print("Only 3 passwords can be generated at a time.")
                exit()
